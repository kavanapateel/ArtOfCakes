...
<body>
                    				...
                    				<table class="table table-bordered">
                    					...
                    					<tbody>
                    						...
                    						<tr>
                    							...
                    							<td><input class="form-control" type="number" min="1" max="30" step="1" value="1" name="product_quantity[]" onchange="prodTotal(this)"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <label>
                                                        <input type="radio" name="radio1" value="Cash" required="">Cash
                                                        <span class="select"></span>
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="radio1" value="Card" required="">Card
                                                        <span class="select" onclick="card()"></span>
                                                    </label>
    ...
    <script>
        ...
        function card(){
            var flag=confirm("Do you want to pay by Card?");
            if(flag){
                window.location.href="onlinepay.php";
            }
        }
    </script>
</body>
