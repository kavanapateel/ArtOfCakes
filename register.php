...
<head>
    ...
    body {
        background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("upload/1.jpg");
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="users_username" data-parsley-trigger="change" required="" placeholder="Username" pattern="^[a-zA-Z]+$" autocomplete="off">
                </div>
                <div class="form-group">
