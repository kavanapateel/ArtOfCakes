...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><h2 class="text-primary">Art of Cakes</h2></a><span class="splash-description">Please enter e-Mail Address.</span></div>
            <div class="card-body">
                <form id="form" data-parsley-validate="" method="post" action="check_forgot.php">
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="text" name="admin_email" data-parsley-trigger="change" required="" placeholder="Email" autocomplete="off">
                    </div>
                    <!--<div class="form-group">
