...
<body>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="confirm_orders(<?php echo $res['orders_id'];?>)" class="btn btn-space btn-success">CONFIRM</button>
    ...
    <div class="modal fade" id="exampleModal1" data-backdrop="static" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="confirm_orders.php" id="form" method="post" enctype="multipart/form-data">
            </form>
          </div>
        </div>
    </div>
    ...
    <script>
        ...
        function confirm_orders(orders_id) {
            var flag = confirm("Do you want to confirm?");
            if (flag) {
                window.location.href = "confirm_orders.php?orders_id="+orders_id;
            }
        }
