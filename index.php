    ...
    <div class="dashboard-main-wrapper">
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <div class="logo">
                <img src="upload/logo.png" width="100px" style="cursor: pointer;" alt="" >
            </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner rounded">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="upload/cake1.jpg" alt="First slide">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="upload/cake2.jpg" alt="Second slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="upload/cake3.jpg" alt="Third slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="upload/cake4.jpg" alt="Fourth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="upload/cake5.jpg" alt="Fifth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="upload/cake6.jpg" alt="Sixth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                ...
                <div class="row mx-5">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                        ...
                        <div class="row owl-carousel owl-theme trend-foods">
                            <?php
                                require_once('config.php');
                                $tspecial_query = "SELECT * FROM cake_shop_product WHERE product_trend='1'";
                                                            ...
                                                            <h3 class="box-card-title"></h3>
                                                                ...
                                                                <h4 class="box-card-price">
                                                                    ...
                                                                    <span class="veg-non-veg-tag">
                                                                        <i class="fa fa-circle <?= $item['product_type'] == 'Veg' ? 'veg-item':'non-veg-item'; ?>"></i>
                                                                    </span>
