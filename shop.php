                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active" href="#" id="navbarDropdownMenuLink1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Category</a>
                        ...
                        <div class="product-thumbnail rounded">
                            <div class="product-img-head">
                                <div class="product-img">
                                    ...
                                    ?>
                                    <img src="upload/<?php echo $file_array[0];?>" class="img-fluid">
                                </div>
                            </div>
                            <div class="product-content">
                                <div class="product-content-head">
                                    <!--<div class="veg-non-veg-tag">
                                        <i class="fa fa-circle <?php echo $res['product_type'] == 'Veg' ? 'veg-item':'non-veg-item'; ?>"></i>
                                    </div> -->
                                    <h3 class="product-title"><?php echo $res['product_name'];?></h3>
                                    <div class="product-price">Rs. <?php echo $res['product_price'];?></div>
                                </div>
                                <div class="product_btn">
                                <?php if($res['product_status'] == '0') : ?>
                                        <button onclick="add_cart(<?php echo $res['product_id'];?>)" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
                                        <?php else : ?>
